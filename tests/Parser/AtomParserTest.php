...
class AtomParserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testItemId()
    {
        ...
        $this->assertNotEmpty($feed->items);
        $this->assertEquals(
             '3841e5cf232f5111fc5841e9eba5f4b26d95e7d7124902e0f7272729d65601a6',
                 $feed->items[0]->getId()
        );
    }
    ...
    public function testItemUrl()
    {
        ...
        $this->assertEquals(
             'http://www.guyrutenberg.com/2014/12/20/kindle-paperwhite-unable-to-open-item/',
                 $feed->items[1]->getUrl()
        );
        ...
        $this->assertNotEmpty($feed->items);
        $this->assertEquals(
             'http://www.bbc.co.uk/urdu/world/2014/03/140316_missing_malaysia_plane_pilot_mb.shtml',
                 $feed->items[0]->getUrl()
        );
        $this->assertEquals(
             'http://www.bbc.co.uk/urdu/pakistan/2014/03/140316_taliban_talks_pro_ibrahim_zs.shtml',
                 $feed->items[1]->getUrl()
        );
        ...
        $this->assertNotEmpty($feed->items);
        $this->assertEquals(
             'http://feedproxy.google.com/~r/blogspot/MKuf/~3/S_hccisqTW8/a-chrome-experiment-made-with-some.html',
                 $feed->items[0]->getUrl()
        );
    }
    ...
    public function testItemDate()
    {
        ...
        $feed   = $parser->execute();
        $this->assertNotEmpty($feed->items);
        $this->assertEquals(null, $feed->items[4]->getDate());
        ...
        $this->assertEquals(
             1336825342,
                 $feed->items[1]->getDate()->getTimestamp(),
                 '',
                 1
        ); // Should return the published date
    }
